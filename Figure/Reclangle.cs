...
namespace Figure
{
    ...
    internal class Rectangle : Figure
    {
        ...
        {
            return $"{nameof(Rectangle)} Points: {this.Points[0]}, {this.Points[1]}, {this.Points[2]}, {this.Points[3]}; Area: {Area} Perimeter:{Perimeter} Center: {Points[0].CoordinateX}, {Points[0].CoordinateY}";
        }
    }
}
